...
<blockquote>
<dfn>**Contributions** start with **community conversations** that lead to **positive change.**</dfn> `common-vocabulary's` open source collaboration model has five steps:
