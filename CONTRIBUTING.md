...
<blockquote>
<dfn><strong>Contributions</strong> start with <strong>community conversations</strong> that lead to <strong>positive change.</strong></dfn> `common-vocabulary's` open source collaboration model has five steps:
